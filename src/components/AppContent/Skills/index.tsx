                ...
                >
                  {[leftItems, rightItems].map((side, sideIndex) => (
                    <div
                      ...
                      className="space-y-4 xl:space-y-8 w-full"
                    >
                      {side.map((item, idx) => (
                        <div
                        ...
                        >
                          ...
                          <ul className="space-y-1 text-[12px] md:text-[28px] lg:text-[14px] xl:text-[16px] text-gray-300 overflow-hidden">
                            {item.skills.map((skill, idx) => (
                              <li
                                key={`${skill}-${idx}`}
                                className="flex before:content-['•'] before:mr-2 before:text-[#AF9661]"
                              >
                                {skill}
                              </li>
                            ))}
